...
describe('Test User Handlers', function () {
    it('Successfully returns a list of users', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res, response;
    ...
    it('Successfully returns a user by id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
