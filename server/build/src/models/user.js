            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [user.firstname, user.lastname])];
                    case 2:
                        result = _a.sent();
                        if (result) {
                            password = result.rows[0].password;
                            if (bcrypt_1.default.compareSync(user.password + process.env.BCRYPT_PASSWORD, password.toString())) {
