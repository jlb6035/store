...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.create({ status: req.body.status, user_id: req.body.user_id })];
            case 1:
                newOrder = _a.sent();
                res.json(newOrder);
                return [3 /*break*/, 3];
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.addProduct(req.body.quantity, req.params.id, req.body.productId)];
            case 1:
                newProduct = _a.sent();
                res.json(newProduct);
                return [3 /*break*/, 3];
            case 2:
                err_4 = _a.sent();
                throw new Error("Something went wrong ... " + err_4);
            case 3: return [2 /*return*/];
        }
    });
}); };
